    ...
    if (userNotExist) {
      ...
      if (response) {
        ...
        const data = {
          ...
          music_school_id: urlParameters.token,
          date_joined: dateJoined,
          teacher_code: receiver,
        };
        const secondResponse = await axios({
          method: "POST",
          url: `https://8nnc5jq04m.execute-api.us-east-1.amazonaws.com/music_portal/reg-teacher/${urlParameters.token}`,
          // headers: {
          //   Authorization: `Bearer ${token}`,
          // },
          data: { data },
        ...
        if (secondResponse) {
          ...
          console.log(receiver);
          navigate(`/teachers/${urlParameters.token}`);
        }
      }
    } else {
      const response = await axios({
